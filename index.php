...
<body>
    ...
    <!-- container to hold how many total books in library? I don't know if we want to add that -->
    <!-- <div id="book-total">
        <p id="book-count">N/A</p>
        <span id="book-label">Books in Library</span>
    </div> -->

    <!-- Container To Hold All Books @ Top of Page -->
    <div id="all-books"></div>

    <!-- Container To Add Books -->
